            ...
            :schema="[
              {
                ...
                label: t('components.tagView.reload'),
              ...
              },
              {
                ...
                label: t('components.tagView.closeTab'),
              ...
              },
              {
                ...
                label: t('components.tagView.closeTheLeftTab'),
                disabled:
                  !!visitedViews?.length &&
              ...
              },
              {
                ...
                label: t('components.tagView.closeTheRightTab'),
                disabled:
                  !!visitedViews?.length &&
              ...
              },
              {
                ...
                label: t('components.tagView.closeOther'),
                disabled: selectedTag?.fullPath !== item.fullPath,
                command: () => {
                  closeOthersTags()
                }
              },
              {
                ...
                label: t('components.tagView.closeAll'),
                command: () => {
                  closeAllTags()
                }
              }
